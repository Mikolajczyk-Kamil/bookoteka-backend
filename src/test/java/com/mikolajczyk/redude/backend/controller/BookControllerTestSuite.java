...
public class BookControllerTestSuite {
    ...
    @Test
    public void testUpdateRatingShouldFetchSuccess() throws Exception {
        //Given
        User user = new User(1L, "googleId1", "name1", "lastname1", "email1", "pictureUrl1");
        ...
        //When & Then
        mockMvc.perform(MockMvcRequestBuilders.put(apiRoot)
                .header("Authorization", "token")
                .content(jsonContent)
                .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    @Test
    public void testUpdateRatingShouldFetchBookNotFound() throws Exception {
        //Given
        User user = new User(1L, "googleId1", "name1", "lastname1", "email1", "pictureUrl1");
        UserDto userDto = new UserDto(1L, "googleId1", "name1", "lastname1", "email1", "pictureUrl1");
        Book book = new Book(2L, "googleId1", "isbn1", "title1", "author1", "categories1");
    ...
    @Test
    public void testUpdateRatingShouldFetchUserNotFound() throws Exception {
        //Given
        User user = new User(1L, "googleId1", "name1", "lastname1", "email1", "pictureUrl1");
        UserDto userDto = new UserDto(1L, "googleId1", "name1", "lastname1", "email1", "pictureUrl1");
        Book book = new Book(2L, "googleId1", "isbn1", "title1", "author1", "categories1");
    ...
    @Test
    public void testUpdateRatingShouldFetchVerificationFailed() throws Exception {
        //Given
        UserDto userDto = new UserDto(1L, "googleId1", "name1", "lastname1", "email1", "pictureUrl1");
        BookDto bookDto = new BookDto("googleId1", "title1", "author1");
        RatingDto ratingDto = new RatingDto(userDto, bookDto, 10, "comment1");
